...
<body>
        ...
        <nav class="navbar">
            <div class="navbar-start">
                <div class="dropdown">
                    ...
                    <ul tabindex="0" class="menu menu-sm dropdown-content mt-3 z-[1] p-2 shadow rounded-box w-80">
                        <li>
                            <a href="{{ url('/') }}">
            ...
            <div class="navbar-center">
                <a class="btn btn-ghost normal-case text-2xl">Athian Rizki</a>
            </div>
            <div class="navbar-end">
                <button class="btn btn-ghost btn-circle" style="display: none">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24"
                        stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
    ...
    <footer class="footer footer-center bg-base-200 text-base-content rounded">
        <div class="flex grid-flow-col gap-4">
            ...
            <a href="{{ url('/organisasi') }}" class="link link-hover">Pengalaman</a>
            <a href="{{ url('/sertifikat') }}" class="link link-hover">Skils dan Sertifikat</a>
            <a href="{{ url('/project') }}" class="link link-hover">Project</a>
            <a href="{{ url('/about') }}" class="link link-hover">About</a>
        </div>
        <div class="svg">
